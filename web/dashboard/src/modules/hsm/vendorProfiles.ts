...
export const HSM_VENDOR_PROFILES: Record<HSMVendorID, HSMVendorProfile> = {
  ...
  securosys: {
    ...
    defaultPINEnvVar: "SECUROSYS_HSM_PIN",
    endpointTerm: "Primus Endpoint / Service Proxy",
    slotTerm: "PKCS#11 Slot ID",
    partitionTerm: "Partition / User Name",
    tokenTerm: "Partition Token Label",
