...
const FEATURE_DEPENDENCIES: Partial<Record<FeatureKey, string[]>> = {
  ...
  autokey_provisioning: ["kms-autokey"],
  artifact_signing: ["kms-signing"],
  key_access_justifications: ["kms-key-access"],
  workload_identity: ["kms-workload-identity"],
  confidential_compute: ["kms-confidential"],
