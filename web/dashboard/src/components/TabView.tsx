...
const baseTabs: Record<TabId, PanelSpec[]> = {
  ...
  hsm_primus: [{ key: "hsm", title: "HSM / Primus", subtitle: "Hardware session pool and software vault fallback", fields: [{ key: "mode", label: "Mode", kind: "select", options: ["hardware", "software", "auto"] }, { key: "endpoint", label: "HSM Endpoint", kind: "text", placeholder: "primus.local:2300" }, { key: "partition", label: "Partition", kind: "text", placeholder: "root" }], actions: ["Apply HSM Mode", "Test Wrap/Unwrap"] }],
