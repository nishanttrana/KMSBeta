...
const baseTabs: Record<TabId, PanelSpec[]> = {
  ...
  byok: [{ key: "byok", title: "Cloud BYOK", subtitle: "Register cloud account and import key references", fields: [{ key: "provider", label: "Provider", kind: "select", options: ["aws", "azure", "gcp", "oci"] }, { key: "account", label: "Account", kind: "text", placeholder: "bank-alpha-prod" }, { key: "external_ref", label: "External Key Ref", kind: "text", placeholder: "arn:aws:kms:..." }], actions: ["Register Account", "Sync Inventory"] }],
  ...
  ekm: [{ key: "ekm", title: "EKM Agent Hub", subtitle: "Agent registration and TDE key operations", fields: [{ key: "db_type", label: "Database", kind: "select", options: ["postgresql", "oracle", "mongodb", "mysql"] }, { key: "host", label: "Host", kind: "text", placeholder: "db01.bank.local" }, { key: "tenant", label: "Tenant", kind: "text", placeholder: "bank-alpha" }], actions: ["Register Agent", "Issue TDE Key"] }],
  kmip: [{ key: "kmip", title: "KMIP Operations", subtitle: "Client registration and object workflow", fields: [{ key: "client_cn", label: "Client CN", kind: "text", placeholder: "tenant-bank-alpha:kmip-client" }, { key: "operation", label: "Operation", kind: "select", options: ["register", "create", "get", "activate", "destroy"] }, { key: "object_id", label: "Object ID", kind: "text", placeholder: "optional" }], actions: ["Execute KMIP", "Session Diagnostics"] }],
  hsm_primus: [{ key: "hsm", title: "HSM / Primus", subtitle: "Hardware session pool and software vault fallback", fields: [{ key: "mode", label: "Mode", kind: "select", options: ["hardware", "software", "auto"] }, { key: "endpoint", label: "HSM Endpoint", kind: "text", placeholder: "primus.local:2300" }, { key: "partition", label: "Partition", kind: "text", placeholder: "bank-alpha" }], actions: ["Apply HSM Mode", "Test Wrap/Unwrap"] }],
