...
const SUB_PANES: Record<string, any[]> = {
  ...
  hsm: [
    ...
    { id: "hsm-securosys", label: "Securosys Primus HSM", hint: "Primus PKCS#11 library, partition user and token label", icon: ShieldCheck, feature: "hsm_hardware_or_software" },
