...
func buildAuditEventCatalog() map[string]EventMeta {
	...
	overrides := map[string]EventMeta{
		...
		"audit.key.anomaly_scan_completed":        {Severity: "MEDIUM", Category: "key"},
		"audit.key.dspm_finding_upserted":         {Severity: "HIGH", Category: "key"},
		"audit.key.kdf_derived":                   {Severity: "MEDIUM", Category: "key"},
		"audit.key.escrow_shamir_split":           {Severity: "HIGH", Category: "key"},
		"audit.key.escrow_shamir_verified":        {Severity: "MEDIUM", Category: "key"},
		"audit.key.audit_chain_anchored":          {Severity: "MEDIUM", Category: "key"},
		"audit.key.material_fingerprint_verified": {Severity: "HIGH", Category: "key"},
		"audit.key.searchable_token_generated":    {Severity: "MEDIUM", Category: "key"},
		"audit.key.compliance_dashboard_viewed":   {Severity: "LOW", Category: "key"},
		"audit.key.cost_optimization_viewed":      {Severity: "LOW", Category: "key"},
